    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('name', models.CharField(max_length=128, unique=True, verbose_name='Наименование')),
                ('cover', models.ImageField(unique=True, upload_to=games.utils.get_cover_path, verbose_name='Обложка')),
                ('hover_cover', models.ImageField(unique=True, upload_to=games.utils.get_hover_path, verbose_name='Наведение на обложку')),
                ...
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='games', to='games.gener', verbose_name='Жанр')),
            ],
            options={
                'verbose_name': 'Игра',
